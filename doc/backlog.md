...
- **Whitelist** — ⏸ **DEFERRED indefinitely** (Step 232 conversation). Semantic was ambiguous; user opted to do Block first, reassess after. UI placeholder button retained.
